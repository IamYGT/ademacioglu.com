...
<html lang="tr">
	<head>
		...
		<!-- Title -->
		<title>Adem Acıoğlu l Hakkımıza</title>
		...
		<div id="body-content">
			...
			<section id="page-header-secion" class="alter-heading">
				...
				* Use class "parallax" to enable parallax effect.
				-->
				<div class="page-header-image parallax bg-image" style="background-image: url(assets/img/headings/heading-7.jpg); background-position: 50% 73%;"></div>
				...
				<div class="container page-header-content no-padding max-width-800 text-center">
					<div class="row">
						<div class="col-lg-12">
							...
							<h1 class="album-title">HAKKIMIZDA</h1>
							<ol class="breadcrumb">
 ...
 <?php
if($db->veriSaydir("hakkimizda", array(), array()) > 0) {
$bilgi= $db->VeriOkuCoklu("hakkimizda", array(), array(), "row", "ASC",3);
$bilgial= $db->bilgial;
 ...
 ?>  
								...
								<div class="row margin-top-40">
									...
									<div class="col-md-12 text-center">
										<a href="iletisim.php" class="btn btn-default btn-rounded-5x">İLETİŞİM</a>
										<a href="album.php" class="btn btn-primary btn-rounded-5x">ÇEKİMLERİMİZ</a>
									</div> <!-- /.col -->
